<?php
	...
	{
		if (isset($_POST['submitdd'])) {
			$semail = mysqli_real_escape_string($conn, $_POST['semail']);
			$sql = "DELETE FROM `dues` WHERE `sEmail` ='$semail'";
...
<body>
	...
	<div style="background-color: #000;">
		<form style = "margin-left: 40%;" action = "dues.php" method=POST>
			<input type="text" name="semail" placeholder="Enter Student Email" class = "submitbutton submitbutton1">
			<input type="submit" name="submitdd" value="Delete Entry" class="submitbutton submitbutton1">
		</form>
	</div>
